...
public class Example7{
    ...
    public static void main(String[] args) {
        //  variable para almacenar el contexto, que significa el contenedor de Spring
        var context = new AnnotationConfigApplicationContext(ProjectConfig.class);

        Vehicle volkswagen = new Vehicle();
        volkswagen.setName("Volkswagen");
        Supplier<Vehicle> volkswagenSupplier = () -> volkswagen; // lambda expression, que devuelve un objeto Vehicle con el metodo getName
